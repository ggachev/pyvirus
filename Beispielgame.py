...
# kann in der Zukunft in einen Dictionary umgewandelt werden
...
# Logik ist analog zu Hauptvirus
# Verzoegerung mithilfe des Zustandsspeichers
    virenIndex = 0
